...
import (
	...
	store "github.com/and-period/marche/api/internal/store"
...
func (m *MockStoreService) CreateStore(ctx context.Context, in *store.CreateStoreInput) (*entity.Store, error) {
	m.ctrl.T.Helper()
...
func (m *MockStoreService) GetStore(ctx context.Context, in *store.GetStoreInput) (*entity.Store, error) {
	m.ctrl.T.Helper()
...
func (m *MockStoreService) ListStaffsByStoreID(ctx context.Context, in *store.ListStaffsByStoreIDInput) (entity.Staffs, error) {
	m.ctrl.T.Helper()
...
func (m *MockStoreService) ListStores(ctx context.Context, in *store.ListStoresInput) (entity.Stores, error) {
	m.ctrl.T.Helper()
...
func (m *MockStoreService) UpdateStore(ctx context.Context, in *store.UpdateStoreInput) error {
	m.ctrl.T.Helper()
