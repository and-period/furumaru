...
type CreateCoordinatorRequest struct {
	...
	CompanyName      string `json:"companyName,omitempty"`      // 会社名
	...
	TwitterAccount   string `json:"twitterAccount,omitempty"`   // Twitterアカウント
	InstagramAccount string `json:"instagramAccount,omitempty"` // Instagramアカウント
	FacebookAccount  string `json:"facebookAccount,omitempty"`  // Facebookアカウント
