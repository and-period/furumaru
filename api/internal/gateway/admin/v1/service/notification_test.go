	...
	}{
		{
			...
			expect: &Notification{
				Notification: types.Notification{
					...
					Title:       "キャベツ祭り開催",
					Body:        "旬のキャベツを大安売り",
					Targets:     []types.NotificationTarget{1, 2},
	...
	}{
		{
			...
			notification: &Notification{
				Notification: types.Notification{
					...
					Title:       "キャベツ祭り開催",
					Body:        "旬のキャベツを大安売り",
					Targets:     []types.NotificationTarget{3, 4},
					PublishedAt: 1640962800,
					CreatedAt:   1640962800,
					UpdatedAt:   1640962800,
				},
			...
			promotion: &Promotion{
				Promotion: types.Promotion{
					...
					Description:  "セール詳細",
					Public:       true,
					DiscountType: types.DiscountTypeAmount,
					DiscountRate: 3980,
					Code:         "code",
					StartAt:      1640962800,
					EndAt:        1640962800,
			...
			notifications: Notifications{
				{
					Notification: types.Notification{
						ID:          "notification-id",
						Type:        types.NotificationTypeLive,
						CreatedBy:   "admin-id",
						UpdatedBy:   "admin-id",
						Title:       "キャベツ祭り開催",
						Body:        "旬のキャベツを大安売り",
				...
				},
				{
					Notification: types.Notification{
						ID:          "notification-id",
						Type:        types.NotificationTypePromotion,
						CreatedBy:   "admin-id",
						UpdatedBy:   "admin-id",
						Title:       "",
						Body:        "旬のキャベツを大安売り",
