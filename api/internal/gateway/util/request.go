...
func GetQueryBool(ctx *gin.Context, query string, defaultValue bool) (bool, error) {
	str := strconv.FormatBool(defaultValue)
	return strconv.ParseBool(ctx.DefaultQuery(query, str))
}
