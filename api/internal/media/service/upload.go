...
func (s *service) GetBroadcastArchiveMP4UploadURL(
	...
	return s.generateUploadURL(
		ctx,
		&in.GenerateUploadURLInput,
		entity.BroadcastArchiveRegulation,
		in.ScheduleID,
	)
}

func (s *service) GetBroadcastLiveMP4UploadURL(
	ctx context.Context,
 ...
 * オンデマンド配信関連
 */
func (s *service) GetVideoThumbnailUploadURL(
	ctx context.Context,
	in *media.GenerateUploadURLInput,
) (*entity.UploadEvent, error) {
...
func (s *service) GetVideoFileUploadURL(
	ctx context.Context,
	in *media.GenerateUploadURLInput,
) (*entity.UploadEvent, error) {
 ...
 * コーディネータ関連
 */
func (s *service) GetCoordinatorThumbnailUploadURL(
	ctx context.Context,
	in *media.GenerateUploadURLInput,
) (*entity.UploadEvent, error) {
...
func (s *service) GetCoordinatorHeaderUploadURL(
	ctx context.Context,
	in *media.GenerateUploadURLInput,
) (*entity.UploadEvent, error) {
...
func (s *service) GetCoordinatorBonusVideoUploadURL(
	ctx context.Context,
	in *media.GenerateUploadURLInput,
) (*entity.UploadEvent, error) {
 ...
 * 生産者関連
 */
func (s *service) GetProducerThumbnailUploadURL(
	ctx context.Context,
	in *media.GenerateUploadURLInput,
) (*entity.UploadEvent, error) {
...
func (s *service) GetProducerHeaderUploadURL(
	ctx context.Context,
	in *media.GenerateUploadURLInput,
) (*entity.UploadEvent, error) {
...
func (s *service) GetProducerPromotionVideoUploadURL(
	ctx context.Context,
	in *media.GenerateUploadURLInput,
) (*entity.UploadEvent, error) {
...
func (s *service) GetProducerBonusVideoUploadURL(
	ctx context.Context,
	in *media.GenerateUploadURLInput,
) (*entity.UploadEvent, error) {
 ...
 * 購入者関連
 */
func (s *service) GetUserThumbnailUploadURL(
	ctx context.Context,
	in *media.GenerateUploadURLInput,
) (*entity.UploadEvent, error) {
 ...
 * 商品関連
 */
func (s *service) GetProductMediaImageUploadURL(
	ctx context.Context,
	in *media.GenerateUploadURLInput,
) (*entity.UploadEvent, error) {
...
func (s *service) GetProductMediaVideoUploadURL(
	ctx context.Context,
	in *media.GenerateUploadURLInput,
) (*entity.UploadEvent, error) {
 ...
 * 品目関連
 */
func (s *service) GetProductTypeIconUploadURL(
	ctx context.Context,
	in *media.GenerateUploadURLInput,
) (*entity.UploadEvent, error) {
 ...
 * 開始スケジュール関連
 */
func (s *service) GetScheduleThumbnailUploadURL(
	ctx context.Context,
	in *media.GenerateUploadURLInput,
) (*entity.UploadEvent, error) {
...
func (s *service) GetScheduleImageUploadURL(
	ctx context.Context,
	in *media.GenerateUploadURLInput,
) (*entity.UploadEvent, error) {
...
func (s *service) GetScheduleOpeningVideoUploadURL(
	ctx context.Context,
	in *media.GenerateUploadURLInput,
) (*entity.UploadEvent, error) {
 ...
 * 体験関連
 */
func (s *service) GetExperienceMediaImageUploadURL(
	ctx context.Context,
	in *media.GenerateUploadURLInput,
) (*entity.UploadEvent, error) {
...
func (s *service) GetExperienceMediaVideoUploadURL(
	ctx context.Context,
	in *media.GenerateUploadURLInput,
) (*entity.UploadEvent, error) {
...
func (s *service) GetExperiencePromotionVideoUploadURL(
	ctx context.Context,
	in *media.GenerateUploadURLInput,
) (*entity.UploadEvent, error) {
 ...
 * スポット関連
 */
func (s *service) GetSpotThumbnailUploadURL(
	ctx context.Context,
	in *media.GenerateUploadURLInput,
) (*entity.UploadEvent, error) {
...
func (s *service) generateUploadURL(
	...
	if err != nil {
		return nil, fmt.Errorf(
			"service: failed to get object key: %s: %w",
			err.Error(),
