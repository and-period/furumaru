...
func (b *Broadcast) Fill() (err error) {
	b.ArchiveMetadata, err = b.unmarshalArchiveMetadata()
	return
}

func (b *Broadcast) unmarshalArchiveMetadata() (*BroadcastArchiveMetadata, error) {
	if b.ArchiveMetadataJSON == nil {
		return &BroadcastArchiveMetadata{}, nil
	}
	metadata := &BroadcastArchiveMetadata{}
	return metadata, json.Unmarshal(b.ArchiveMetadataJSON, &metadata)
}

func (b *Broadcast) FillJSON() error {
	metadata, err := BroadcastMarshalArchiveMetadata(b.ArchiveMetadata)
	if err != nil {
		return err
	}
	b.ArchiveMetadataJSON = metadata
	return nil
}

func BroadcastMarshalArchiveMetadata(metadata *BroadcastArchiveMetadata) (datatypes.JSON, error) {
