...
func TestOrderPayment_Capturable(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name   string
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			assert.Equal(t, tt.expect, payment.Capturable())
		})
	}
}

func TestOrderPayment_Cancelable(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name   string
		status PaymentStatus
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			t.Parallel()
			payment := &OrderPayment{Status: tt.status}
			assert.Equal(t, tt.expect, payment.Cancelable())
		})
	}
}
