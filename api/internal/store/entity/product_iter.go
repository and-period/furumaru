...
func (ps Products) IterFilter(productIDs ...string) iter.Seq[*Product] {
	...
	return collection.FilterIter(ps, func(p *Product) bool {
...
func (ps Products) IterMap() iter.Seq2[string, *Product] {
	return collection.MapIter(ps, func(p *Product) (string, *Product) {
		return p.ID, p
	})
}
...
func (ps Products) IterMapByRevision() iter.Seq2[int64, *Product] {
	return collection.MapIter(ps, func(p *Product) (int64, *Product) {
