...
/**
 * Check if a given object implements the ResponseProducer interface.
 */
export function instanceOfResponseProducer(value: object): value is ResponseProducer {
    return true;
}

export function ResponseProducerFromJSON(json: any): ResponseProducer {
    return ResponseProducerFromJSONTyped(json, false);
}

export function ResponseProducerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResponseProducer {
    if (json == null) {
        return json;
    }
    return {
...
export function ResponseProducerToJSON(value?: ResponseProducer | null): any {
    if (value == null) {
        return value;
    }
    return {
