 ...
 *
 * @export
 * @interface V1UpdateUserPasswordRequest
 */
export interface V1UpdateUserPasswordRequest {
  /**
   * 現在のパスワード
   * @type {string}
   * @memberof V1UpdateUserPasswordRequest
   */
  oldPassword: string
  /**
   * 新しいパスワード (8~32文字, 英小文字,数字を少なくとも1文字ずつは含む)
...
export const UserApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    v1ForgotUserPassword: async (
      body: ForgotUserPasswordRequest,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'body' is not null or undefined
...
export const UserApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async v1CreateUser(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserMeResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1CreateUser(
        body,
        options
      )
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.v1CreateUserWithOAuth(body, options)
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    async v1DeleteUser(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1DeleteUser(
        options
      )
      return createRequestFunction(
        localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.v1ForgotUserPassword(body, options)
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    async v1GetUserMe(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserMeResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1GetUserMe(
        options
      )
      return createRequestFunction(
        localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.v1ResetUserPassword(body, options)
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.v1UpdateUserEmail(body, options)
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    async v1VerifyUser(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1VerifyUser(
        body,
        options
      )
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.v1VerifyUserEmail(body, options)
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
...
export const UserApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    v1CreateUserWithOAuth(
      body: object,
      options?: any
    ): AxiosPromise<UserMeResponse> {
      return localVarFp
        .v1CreateUserWithOAuth(body, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    v1ForgotUserPassword(
      body: ForgotUserPasswordRequest,
      options?: any
    ): AxiosPromise<object> {
      return localVarFp
        .v1ForgotUserPassword(body, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    v1ResetUserPassword(
      ...
      return localVarFp
        .v1ResetUserPassword(body, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    v1UpdateUserEmail(
      ...
      return localVarFp
        .v1UpdateUserEmail(body, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    v1VerifyUserEmail(
      ...
      return localVarFp
        .v1VerifyUserEmail(body, options)
        .then((request) => request(axios, basePath))
    },
  }
}
