...
<template>
  <div class="text-main">
    ...
    <div class="mt-20 flex flex-col items-center justify-center">
      <p class="text-xl font-medium tracking-[2px]">
        お客様の注文番号は「1111111」です
      </p>
      <div
        class="flex flex-col items-center justify-center text-[16px] font-medium"
      >
        <p class="mt-10">
          ご登録いただいたメールアドレスに確認メールをお送りしましたのでご確認ください。
        </p>
        <p>
          メールが届かない場合は上記の注文番号をお書き添えの上、こちらからお問い合わせください。
        </p>
        <p>
