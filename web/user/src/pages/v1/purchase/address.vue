          ...
          <div class="w-full bg-base p-10 text-main">
            ...
            <div>
              ...
              <div class="grid grid-cols-4 gap-2 py-6">
                ...
                <input type="text" class="bg-gray-50 border border-gray-300 p-2.5 w-full" placeholder="クーポンコード">
                </div>

                <button
                class="bg-main w-full justify-self-end p-2 text-[16px] text-white"
              >
                適用する
              </button>
              </div>
