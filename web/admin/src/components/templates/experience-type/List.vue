...
import type { CreateExperienceTypeRequest, ExperienceType, UpdateExperienceTypeRequest } from '~/types/api/v1'
...
const { dialogVisible, selectedItem, open: openDeleteDialog, close: closeDeleteDialog } = useDeleteDialog<ExperienceType>()
