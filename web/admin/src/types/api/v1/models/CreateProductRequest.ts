...
import type { CreateProductMedia } from './CreateProductMedia';
import {
    CreateProductMediaFromJSON,
    CreateProductMediaFromJSONTyped,
    CreateProductMediaToJSON,
    CreateProductMediaToJSONTyped,
} from './CreateProductMedia';
...
export function CreateProductRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateProductRequest {
    ...
    return {
        ...
        'media': ((json['media'] as Array<any>).map(CreateProductMediaFromJSON)),
        'name': json['name'],
...
export function CreateProductRequestToJSONTyped(value?: CreateProductRequest | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'media': ((value['media'] as Array<any>).map(CreateProductMediaToJSON)),
        'name': value['name'],
