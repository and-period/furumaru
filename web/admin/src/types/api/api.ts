...
export const AddressApiAxiosParamCreator = function (
  ...
  return {
    ...
    v1SearchPostalCode: async (
      ...
      const localVarPath = `/v1/postal-codes/{postalCode}`.replace(
        `{${'postalCode'}}`,
        encodeURIComponent(String(postalCode))
      )
  ...
  return {
    ...
    async v1SearchPostalCode(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<PostalCodeResponse>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.v1SearchPostalCode(postalCode, options)
...
export const AddressApiFactory = function (
  ...
  return {
    ...
    v1SearchPostalCode(
      ...
      return localVarFp
        .v1SearchPostalCode(postalCode, options)
...
export const AdministratorApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.v1DeleteAdministrator(adminId, options)
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
...
export const AdministratorApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    v1DeleteAdministrator(
      adminId: string,
      options?: any
    ): AxiosPromise<object> {
      return localVarFp
        .v1DeleteAdministrator(adminId, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
...
export const CoordinatorApiAxiosParamCreator = function (
  ...
  return {
    ...
    v1ListRelatedProducers: async (
      ...
      // verify required parameter 'coordinatorId' is not null or undefined
      assertParamExists(
        'v1ListRelatedProducers',
        'coordinatorId',
        coordinatorId
      )
      const localVarPath = `/v1/coordinators/{coordinatorId}/producers`.replace(
        `{${'coordinatorId'}}`,
        encodeURIComponent(String(coordinatorId))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    v1UnrelateProducer: async (
      ...
      const localVarPath =
        `/v1/coordinators/{coordinatorId}/producers/{producerId}`
          .replace(
            `{${'coordinatorId'}}`,
            encodeURIComponent(String(coordinatorId))
          )
...
export const CoordinatorApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.v1DeleteCoordinator(
          coordinatorId,
          options
        )
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.v1ListRelatedProducers(
          coordinatorId,
          limit,
          offset,
          options
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.v1RelateProducers(
          coordinatorId,
          body,
          options
        )
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.v1UnrelateProducer(
          coordinatorId,
          producerId,
          options
        )
...
export const CoordinatorApiFactory = function (
  ...
  return {
    ...
    v1DeleteCoordinator(
      ...
      return localVarFp
        .v1DeleteCoordinator(coordinatorId, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    v1ListRelatedProducers(
      ...
      return localVarFp
        .v1ListRelatedProducers(coordinatorId, limit, offset, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    v1RelateProducers(
      ...
      return localVarFp
        .v1RelateProducers(coordinatorId, body, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    v1UnrelateProducer(
      ...
      return localVarFp
        .v1UnrelateProducer(coordinatorId, producerId, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
...
export const NotificationApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.v1GetNotification(
          notificationId,
          options
        )
      return createRequestFunction(
...
export const NotificationApiFactory = function (
  ...
  return {
    ...
    v1GetNotification(
      ...
      return localVarFp
        .v1GetNotification(notificationId, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
...
export const OrderApiAxiosParamCreator = function (
  ...
  return {
    ...
    v1GetOrder: async (
      ...
      const localVarPath = `/v1/orders/{orderId}`.replace(
        `{${'orderId'}}`,
...
export const OrderApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async v1GetOrder(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrderResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1GetOrder(
        orderId,
        options
      )
      return createRequestFunction(
    ...
    async v1ListOrders(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrdersResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1ListOrders(
        limit,
        offset,
        orders,
        options
...
export const OrderApiFactory = function (
  ...
  return {
    ...
    v1ListOrders(
      ...
      return localVarFp
        .v1ListOrders(limit, offset, orders, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export const ProducerApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.v1DeleteProducer(producerId, options)
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
...
export const ProducerApiFactory = function (
  ...
  return {
    ...
    v1DeleteProducer(producerId: string, options?: any): AxiosPromise<object> {
      return localVarFp
        .v1DeleteProducer(producerId, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    v1ListProducers(
      ...
      return localVarFp
        .v1ListProducers(limit, offset, filters, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
...
export const ProductApiFactory = function (
  ...
  return {
    ...
    v1ListProducts(
      ...
      return localVarFp
        .v1ListProducts(limit, offset, producerId, orders, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
...
export const ScheduleApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.v1CreateSchedule(body, options)
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
...
export const UserApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1GetUser(
        userId,
        options
      )
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1ListUsers(
        limit,
        offset,
        options
      )
...
export const UserApiFactory = function (
  ...
  return {
    ...
    v1ListUsers(
      ...
      return localVarFp
        .v1ListUsers(limit, offset, options)
        .then((request) => request(axios, basePath))
    },
  }
}
