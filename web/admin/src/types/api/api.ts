...
export const CoordinatorApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         *
         * @summary コーディネーター一覧取得
         * @param {number} [limit] 取得上限数(max:200)
         * @param {number} [offset] 取得開始位置(min:0)
         * @param {string} [username] コーディネーター名(あいまい検索)(64文字以内)
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        ...
        /**
         *
         * @summary コーディネーターパスワード更新(ランダム生成)
         * @param {string} coordinatorId コーディネーターID
         * @param {object} body
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
        ...
        /**
         *
         * @summary コーディネーター購入特典動画アップロード
         * @param {File} [video] コーディネーター購入特典映像(mp4形式,200MBまで)
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        ...
        /**
         *
         * @summary コーディネーターヘッダー画像アップロード
         * @param {File} [image] コーディネーターヘッダー画像(png,jpeg形式,10MBまで)
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        ...
        /**
         *
         * @summary コーディネーター紹介動画アップロード
         * @param {File} [video] コーディネーター紹介映像(mp4形式,200MBまで)
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        ...
        /**
         *
         * @summary コーディネーターサムネイルアップロード
         * @param {File} [thumbnail] コーディネーターサムネイル(png,jpeg形式,10MBまで)
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
