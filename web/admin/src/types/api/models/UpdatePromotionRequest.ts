 ...
 */
export function instanceOfUpdatePromotionRequest(value: object): boolean {
    let isInstance = true;
...
export function UpdatePromotionRequestToJSON(value?: UpdatePromotionRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
